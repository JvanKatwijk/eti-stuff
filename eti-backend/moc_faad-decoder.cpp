...
void faadDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        faadDecoder *_t = static_cast<faadDecoder *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->newAudio((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (faadDecoder::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject faadDecoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_faadDecoder.data,
      qt_meta_data_faadDecoder,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void faadDecoder::newAudio(int _t1)
{
